...
/**
 * This is the model class for table "cowriter".
 *
 * The followings are the available columns in table 'cowriter':
 * @property integer $id
 ...
 * @property User $user
 */
class Cowriter extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return Cowriter the static model class
	 */
