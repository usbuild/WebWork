<?php $follow_blogs = Yii::app()->user->model->followBlogs(); ?>
...
<div class="feed-avatar">
    ...
    <div class="feed-avatar-action">
        ...
        <ul>
            ...
            <?php if (in_array($blog, $follow_blogs)): ?>
            <li class="feed-unfollow" data-blog="<?php echo $blog->id?>"
                >取消关注
            </li>
            <?php else: ?>
            <li class="feed-follow" data-blog="<?php echo $blog->id?>"
                >关注
            </li>
            <?php endif;?>
            <li class="feed-visit-blog" data-url="<?=$this->createUrl('view/post/' . $post->id)?>">访问博客</li>
        </ul>
    </div>
</div>
