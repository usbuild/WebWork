...
(function () {
    ...
    var tmp = window.location.pathname;
        URL = window.UEDITOR_HOME_URL||'/blog/plugins/ueditor/';//这里你可以配置成ueditor目录在您网站的相对路径或者绝对路径（指以http开头的绝对路径）
    ...
    window.UEDITOR_CONFIG = {
        ...
        ,toolbars:[["FullScreen","Bold","Italic","Underline","StrikeThrough","|","JustifyLeft","JustifyCenter","JustifyRight","JustifyJustify","|","InsertUnorderedList","InsertOrderedList","BlockQuote","|","InsertImage","Link","Unlink","|","PageBreak","|","Source","HighlightCode","Help"]]
